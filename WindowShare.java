...
public class WindowShare extends SQLRequest{
	...
	private JComboBox shareSetAvaibleComboBox;


	String[] userInfo = {null,null,null,null,null,null,null,null,null};
	String[] choosetypeinfo1 = {null,null,null,null,null,null};
	private JTextField idDeletField;
	private JLabel lblDateDdmmyyyy;
	...
	private void initialize() {
		frame = new JFrame("BD aka Black Dick");
		...
		buttonLogIn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String[][] logVerification;
				//logVerification = getUserInfo(logInfo[0]
				if(tryParse(logInfo[0])>0&&true){// && (int)logInfo[0]>0)
					logPanel.setVisible(false);
					afterLogPanel.setVisible(true);
					//TODO get userinfo
					userInfo[0] = logInfo[0].toString();
					userInfo[1] = "bla";
					userInfo[2] = "bla";
					userInfo[3] = "bla";
					userInfo[4] = "bla";
					...
					JOptionPane.showMessageDialog(null,"veuiller selectionner un ID valide(vous pouvez tester avec '1' pour commencer)");
		...
		btnCreateUser.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				JOptionPane.showMessageDialog(null, "wattup ton nouvelle user ID +1, tu peux le retrouver dans see my objects");
		...
		passwordField.setText("not activated --");
		...
		logInPasswordField.setText("not activated ---");
		...
		afterLogPanel.add(borrowPanel);
				...
				borrowButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						int[] borrow = {tryParse(borrowField.getText()),
										   tryParse(userInfo[0])
						};
						//TODO call function BeginShare(..);
					}
				});
				...
				giveBackObjectbutton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						int[] giveBack = {tryParse(givebackObjectIDField.getText()),
								   tryParse(userInfo[0])
						};
						//TODO chopchop EndShare(..);
					}
				});
				...
				sl_afterLogPanel.putConstraint(SpringLayout.NORTH, deletPanel, 0, SpringLayout.NORTH, afterLogPanel);
				sl_afterLogPanel.putConstraint(SpringLayout.WEST, deletPanel, 6, SpringLayout.EAST, giveBackPanel);
				sl_afterLogPanel.putConstraint(SpringLayout.SOUTH, deletPanel, 114, SpringLayout.NORTH, afterLogPanel);
				sl_afterLogPanel.putConstraint(SpringLayout.EAST, deletPanel, 238, SpringLayout.EAST, giveBackPanel);
				deletPanel.setBackground(Color.LIGHT_GRAY);
				afterLogPanel.add(deletPanel);
				SpringLayout sl_deletPanel = new SpringLayout();
				deletPanel.setLayout(sl_deletPanel);
				
				JLabel deletMyObjectLabel = new JLabel("Delet my object by ID");
				sl_deletPanel.putConstraint(SpringLayout.NORTH, deletMyObjectLabel, 0, SpringLayout.NORTH, deletPanel);
				sl_deletPanel.putConstraint(SpringLayout.WEST, deletMyObjectLabel, 0, SpringLayout.WEST, deletPanel);
				deletPanel.add(deletMyObjectLabel);
				
				JLabel deletObjectIdLabel = new JLabel("Object ID");
				sl_deletPanel.putConstraint(SpringLayout.NORTH, deletObjectIdLabel, 6, SpringLayout.SOUTH, deletMyObjectLabel);
				sl_deletPanel.putConstraint(SpringLayout.WEST, deletObjectIdLabel, 0, SpringLayout.WEST, deletPanel);
				deletPanel.add(deletObjectIdLabel);
				
				idDeletField = new JTextField();
				sl_deletPanel.putConstraint(SpringLayout.NORTH, idDeletField, 0, SpringLayout.NORTH, deletObjectIdLabel);
				sl_deletPanel.putConstraint(SpringLayout.EAST, idDeletField, 0, SpringLayout.EAST, deletPanel);
				deletPanel.add(idDeletField);
				idDeletField.setColumns(10);
				
				JButton deletBtn = new JButton("New button");
				deletBtn.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						int objectToDelet = tryParse(idDeletField.getText());
						int userID = tryParse(userInfo[0]);
						//TODO fonction destroy
					}
				});
				sl_deletPanel.putConstraint(SpringLayout.NORTH, deletBtn, 0, SpringLayout.SOUTH, idDeletField);
				sl_deletPanel.putConstraint(SpringLayout.EAST, deletBtn, 0, SpringLayout.EAST, deletPanel);
				deletPanel.add(deletBtn);
				...
				shareObject.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						String[] shareinfo2={null,null,null,null,null,null,null};						
						if(((String)comboBox.getSelectedItem()).equals("car")){
							String[] shareType = {
									shareIDField.getText(),"lol"
							};
						}
						else if(((String)comboBox.getSelectedItem()).equals("Bike")){
							String[] shareType = {

									shareIDField.getText()
							};
						}
						else{
							String[] shareType = {
						...
						String[] shareItem = {
								...
								shareIDField.getText(),
								shareDescriptionField.getText(),
								sharePriceField.getText(),
								shareTimeField.getText(),
								(String) shareSetAvaibleComboBox.getSelectedItem(),
								(String)comboBox.getSelectedItem()
						};
						
						//TODO fonction get item ID
							JOptionPane.showMessageDialog(null, "wattup ton nouvelle object ID + 1, tu peux le retrouver dans see my objects");

							choosetypeinfo1[0] = null;
							choosetypeinfo1[1] = null;
							choosetypeinfo1[2] = null;
							choosetypeinfo1[3] = null;
							choosetypeinfo1[4] = null;
							choosetypeinfo1[5] = null;
					}
				});
				...
				btnNext.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						choosetypeinfo1[0]=shareIDField.getText();
						choosetypeinfo1[1]=sharePriceField.getText();
						choosetypeinfo1[2]=shareTimeField.getText();
						choosetypeinfo1[3]=shareDescriptionField.getText();
						choosetypeinfo1[4]=(String)comboBox.getSelectedItem();
						choosetypeinfo1[5]=(String)shareSetAvaibleComboBox.getSelectedItem();
				...
				shareIDField.setText("disable");
				shareIDField.setBackground(Color.LIGHT_GRAY);
				...
				shareSetAvaibleComboBox = new JComboBox();
				...
				sl_searchObjectPanel.putConstraint(SpringLayout.NORTH, searchComboBox, 10, SpringLayout.SOUTH, lblSearch);
				searchComboBox.setModel(new DefaultComboBoxModel(new String[] {"Type", "Avaibility", "Proximity", "Price>", "Price<"}));
				sl_searchObjectPanel.putConstraint(SpringLayout.WEST, searchComboBox, 0, SpringLayout.WEST, lblSearch);
				searchObjectPanel.add(searchComboBox);
				
				searchField = new JTextField();
				sl_searchObjectPanel.putConstraint(SpringLayout.SOUTH, searchField, 0, SpringLayout.SOUTH, searchComboBox);
				...
				searchSimpleButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						case 0 : output = (Object[][])searchType(tryParseType(input)).toArray();//type;
							break;
						case 3 : //price>
							output = (Object[][]) searchObjectByPrice(tryParse(input),Integer.MAX_VALUE).toArray();
							break;
						case 4 : //price<
							output = (Object[][]) searchObjectByPrice(0,tryParse(input)).toArray();
							break;
						case 1 : 
							//avaible;
							if(input.equals("yes")||input.equals("oui")||input.equals("vrai")
									||input.equals("true")||input.equals("1"))
								output = (Object[][])searchObjectByDisponibility().toArray();
							else
								;//TODO nothing c niaiseux faire ca
							break;
						case 2 : ;//output = (Object[][])searchObjectByProximity();//proximity;
							break;
						}
						Object[][] rows = {
							...
							JTable table = new JTable(output, cols);//JTable table = new JTable(output, output[0]);
				...
				sl_myObjectPanel.putConstraint(SpringLayout.NORTH, findUserbyObjectPanel, 6, SpringLayout.SOUTH, Modifpanel);
				...
				btnModif.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						String inputID = modifObjectIDField.getText();
						String inputModif = ModificationArea.getText();
						switch(ModificationComboBox.getSelectedIndex()){
						case 0 : if(tryParseBool(inputModif))
							changeObjectDisponibility(tryParse(inputID));
							else changeObjectDisponibility(tryParse(inputID));
							;
						break;
						case 1 : changeObjectPrice(tryParse(inputID),tryParse(inputModif));//price;
						break;
						case 2 : ;//changeObjectShareTime(tryParse(inputID),tryParse(inputModif));//shareTime;
						break;
						case 3 : //description;
						break;
						}
				...
				JLabel lblUserWithMy = new JLabel("Find user with my object by date");
				...
				btnFind.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						int inputID = tryParse(userOnjectIdField.getText());
						...
						Object[][] rows = {
							...
							JTable table = new JTable((String[][]) findObjectBorrowerByDate(inputID,date).toArray(), cols);
							JOptionPane.showMessageDialog(null, new JScrollPane(table), "Results", JOptionPane.INFORMATION_MESSAGE);
				...
				sl_findUserbyObjectPanel.putConstraint(SpringLayout.EAST, txtDdmmyyyy, 0, SpringLayout.EAST, findUserbyObjectPanel);
				txtDdmmyyyy.setText("dd/mm/yyyy");
				findUserbyObjectPanel.add(txtDdmmyyyy);
				...
				lblDateDdmmyyyy = new JLabel("date    dd/mm/yyyy");
				sl_findUserbyObjectPanel.putConstraint(SpringLayout.NORTH, txtDdmmyyyy, 0, SpringLayout.NORTH, lblDateDdmmyyyy);
				sl_findUserbyObjectPanel.putConstraint(SpringLayout.NORTH, btnFind, 0, SpringLayout.SOUTH, lblDateDdmmyyyy);
				sl_findUserbyObjectPanel.putConstraint(SpringLayout.NORTH, lblDateDdmmyyyy, 0, SpringLayout.SOUTH, userOnjectIdField);
				sl_findUserbyObjectPanel.putConstraint(SpringLayout.WEST, lblDateDdmmyyyy, 0, SpringLayout.WEST, findUserbyObjectPanel);
				findUserbyObjectPanel.add(lblDateDdmmyyyy);
				...
				btnFind_1.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						int input = tryParse(usersInterrestedField.getText());
						// if(input >0)TODO InterrsestedUsers(input);
					}
				});
				...
				btnGetMyNotification.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
				...
				btnRemove.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						String input = (String)notificationTypeComboBox.getSelectedItem();
				...
				btnNotifyMe.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						String input = objectIdNotifField.getText();
						//TODO
					}
				});
				...
				btnSeeMyNotification_1.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
				...
				btnGetMyUser.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						//TODO
						Object[][] rows = {
							    {"element","symbol","atomicNumber","atomicMass","valence"},
	...
	public boolean tryParseBool(String txt) {
		  boolean retval = false;
		  if(txt.equals("yes")||txt.equals("oui")||txt.equals("vrai")
					||txt.equals("true")||txt.equals("1"))
			  retval=true;
		  return retval;
		}
	public String tryParseType(String txt) {
		  String retVal = "maison";
		  if(txt.toLowerCase().equals("car")||txt.toLowerCase().equals("auto"))return "auto";
		  if(txt.toLowerCase().equals("bike")||txt.toLowerCase().equals("velo"))return "velo";
		  return retVal;
		}
}
